/******************
 Sorting Algorithm
 ******************/
var SortingAlgorithm = klass(function() {
    this.canvas;
    this.context;
    this.hasAudio = true;
    this.audioOn = -1;
...
/******************
    BUBBLE SORT
 ******************/
var BubbleSort = SortingAlgorithm.extend(function(dataSet, canvasId) {
    this.data = dataSet;
...
/******************
   SELECTION SORT
 ******************/
var SelectionSort = SortingAlgorithm.extend(function(dataSet, canvasId) {
    this.data = dataSet;
    this.dataSetCopy = copy(dataSet);
    this.name = "selection";
    this.canvas = document.getElementById(canvasId);
...
/******************
   INSERTION SORT
 ******************/
var InsertionSort = SortingAlgorithm.extend(function(data, canvasId) {
    this.data = dataSet;
    this.name = "insertion";
    this.dataSetCopy = copy(dataSet);
    this.canvas = document.getElementById(canvasId);
